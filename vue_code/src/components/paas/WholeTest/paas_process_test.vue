<template>
  <CardBox title="PaaS全流程测试" height='100%'>
    <template slot="body">
      <div class="step_box">
      ...
      <div class="steq_panel">
        ...
        <StepOne v-if="active === 1" ref="step_one"  @next_step="next_step" @change_button="change_button"></StepOne>
      ...
      submit_bound_list() {
        ...
        if (this.action === 3) {
          if (this.$refs.step_two_template.bind_template_table_data.length ===0){
            ...
            this.$refs.step_two_template.create_test_task(require_name)
          }
